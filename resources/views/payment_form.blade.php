...
<div class="well">
    ...
    @if (config('unitpay.payment_forms')['cards'])
        <div class="form-group ">
            <form action="https://{{ $payment_fields['DOMAIN'] }}/pay/{{ $payment_fields['PUB_KEY'] }}/card" method="POST" class="form unitpay-form">
    ...
    @if (config('unitpay.payment_forms')['yandex'])
        <div class="form-group pull-left">
            <form action="https://{{ $payment_fields['DOMAIN'] }}/pay/{{ $payment_fields['PUB_KEY'] }}/yandex" method="POST" class="form unitpay-form">
                <input type="hidden" name="sum" value="{{ $payment_fields['PAYMENT_AMOUNT'] }}">
                <input type="hidden" name="account" value="{{ $payment_fields['PAYMENT_NO'] }}">
                <input type="hidden" name="desc" value="{{ $payment_fields['ITEM_NAME'] }}">
                <input type="hidden" name="currency" value="{{ $payment_fields['CURRENCY'] }}">
    ...
    @if (config('unitpay.payment_forms')['qiwi'])
        <div class="form-group">
            <form action="https://{{ $payment_fields['DOMAIN'] }}/pay/{{ $payment_fields['PUB_KEY'] }}/qiwi" method="POST" class="form unitpay-form">
                <input type="hidden" name="sum" value="{{ $payment_fields['PAYMENT_AMOUNT'] }}">
                <input type="hidden" name="account" value="{{ $payment_fields['PAYMENT_NO'] }}">
                <input type="hidden" name="desc" value="{{ $payment_fields['ITEM_NAME'] }}">
                <input type="hidden" name="currency" value="{{ $payment_fields['CURRENCY'] }}">
    ...
    @if (config('unitpay.payment_forms')['cash'])
        <div class="form-group">
            <form action="https://{{ $payment_fields['DOMAIN'] }}/pay/{{ $payment_fields['PUB_KEY'] }}/cash" method="POST" class="form unitpay-form">
                <input type="hidden" name="sum" value="{{ $payment_fields['PAYMENT_AMOUNT'] }}">
                <input type="hidden" name="account" value="{{ $payment_fields['PAYMENT_NO'] }}">
                <input type="hidden" name="desc" value="{{ $payment_fields['ITEM_NAME'] }}">
                <input type="hidden" name="currency" value="{{ $payment_fields['CURRENCY'] }}">
    ...
    @if (config('unitpay.payment_forms')['webmoney'])
        <div class="form-group">
            <form action="https://{{ $payment_fields['DOMAIN'] }}/pay/{{ $payment_fields['PUB_KEY'] }}/webmoney" method="POST" class="form unitpay-form">
                <input type="hidden" name="sum" value="{{ $payment_fields['PAYMENT_AMOUNT'] }}">
                <input type="hidden" name="account" value="{{ $payment_fields['PAYMENT_NO'] }}">
                <input type="hidden" name="desc" value="{{ $payment_fields['ITEM_NAME'] }}">
                <input type="hidden" name="currency" value="{{ $payment_fields['CURRENCY'] }}">
